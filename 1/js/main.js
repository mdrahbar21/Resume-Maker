...
defaultTemplateVars = [ "fontDroid" , "caseNormal" , "titleRuled" , "ruleAbove" , "imageShow" , "rollShow" , "course1" , "tableShow" ,"borderShow", "edyearFirst" , "experience1" , "projects1" ]
...
function changeTemplate(toggleType,toggleValue)
{
	switch(toggleType)
	{
		...
		case 'table':
			...
			break;
		case 'courseTable':
			if(toggleValue=='borderHide')
			{
				$('#courseBor').removeClass('courseBorder');
				$('#vertiBor').removeClass('verticalBorder');
			}
			else
			{
				$('#courseBor').addClass('courseBorder');
				$('#vertiBor').addClass('verticalBorder');
			}
			break;
		case 'edyear':
